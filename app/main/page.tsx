      ...
      <div className="max-w-xl mx-auto">
        ...
        <FadeUp delay={180} className="mb-6">
          <button
            ...
            className="w-full py-4 rounded-2xl font-bold text-base transition-all cursor-pointer disabled:cursor-not-allowed disabled:bg-zinc-200 disabled:text-zinc-400 bg-red-500 hover:bg-red-600 text-white flex items-center justify-center gap-2"
          >
            {loading ? (
