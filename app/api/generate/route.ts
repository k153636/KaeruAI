...
【絶対禁止】
- 「5つの〇〇」「〇〇してみた」「〇〇を検証」など誰でも思いつく汎用タイトルパターン
- プロフィールを読まなくても提案できる企画
- 全ての企画が同じ構造・トーンになること
- テンプレート的な説明文（「①〜をする ②〜が面白い ③〜を得られる」の機械的な繰り返し）

【必須条件】
- クリエイターのプロフィールを精読し、その人物像・動機・スタイルが企画に滲み出ること
- タイトルはそのクリエイターの個性・視点が伝わるものにする
- 5つの企画それぞれが異なるアプローチ・切り口を持つこと
